...
public class MlgScoreboard {
    ...
    public static void create(MlgPlayer player) {
        ...
        ScoreboardFactory.addEntry(player, Names.HIGH_SCORE, "High Score: ", String.valueOf(streakPlayer.getHighScore(player.getMlgName())), 8);
    }
    ...
    public static void update(MlgPlayer player) {
        ...
        ScoreboardFactory.updateEntry(player, Names.HIGH_SCORE, "High Score: ", String.valueOf(streakPlayer.getHighScore(player.getMlgName())));
    }
}
